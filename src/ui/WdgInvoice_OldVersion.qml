...
// This version include all the features and modifications until the Pull request #41.
// This version is compatible with Banana versions wich use Qt version uder 6.5.0
